...
## Compare the results of the numerical and analytical solution methods for a 
## 4-level system both within and beyond the weak-probe limit.

Omegas_all = [[0.1,10,2],[5,10,2]] #2pi MHz
...
ax2.set_xlim(min(Delta_12s), max(Delta_12s))
